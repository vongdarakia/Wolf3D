...
/*
**	Sets up environment for dragging if the left click is pressed,
**	or if scrolling, then does zoom accordingly.
**	4 = scrolling out : zoom out
**	5 = scrolling in : zoom in
**	1 = left click
*/
...
/*
**	Sets environment to know we're no longer pressing down.
**	The button = x + y part is to avoid gcc wall and werrors.
*/
...
int main(int ac, char **av)
{
	...
	mlx_hook(env.win, 4, 1, mouse_down, &env);
	// mlx_hook(pe->env.win, 5, 1, mouse_up, e);
	mlx_loop(env.mlx);
